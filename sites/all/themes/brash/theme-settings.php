 ...
 */
function brash_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['brash_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('brash sample setting'),
  '#default_value' => theme_get_setting('brash_example'),
